...
from main import header,visual,chart3,set_background_image,set_sidebar_background_image
...
set_sidebar_background_image("car_streamlit/ᴇᴅɢᴇ ᴏғ ᴛʜᴇ ᴄʟɪғғ.jpg", zoom=2.5)
